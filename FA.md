...
در اینجا نمایی از **YOLOv8 Dataset Designer** نمایش داده شده است. این ابزار به گونه‌ای طراحی شده است که استفاده از آن بسیار ساده و کاربرپسند باشد و تجربه‌ای روان برای طراحی دیتاست‌ها ارائه دهد.
